...
model_path = os.environ['HOME'] + "/Triton/ensemble/models/sci_2/1"
...
pickle.dump(model, open(model_path + "/sci_2.pkl", 'wb'))

subprocess.run(["{}/Triton/ensemble/fil_backend/scripts/convert_sklearn".format(os.environ['HOME']), model_path + "/sci_2.pkl"])
